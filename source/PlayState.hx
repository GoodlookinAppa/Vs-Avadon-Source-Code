...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Get rid of yourself', 0.2], //From 0% to 19%
		['Man you re shit', 0.4], //From 20% to 39%
		['I don t like you', 0.5], //From 40% to 49%
		['It doesn t convince me', 0.6], //From 50% to 59%
		['I do not care', 0.69], //From 60% to 68%
		['You looking handsome', 0.7], //69%
		['Man You re sexy', 0.8], //From 70% to 79%
		['Yeah baby', 0.9], //From 80% to 89%
		['Jeez you re sexy!', 1], //From 90% to 99%
		['Tankman horny af!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
		...
		if (isStoryMode && !seenCutscene)
		{
			switch (daSong)
			{
				...
				case 'senpai' | 'roses' | 'thorns':
					...
					case 'stressful-thoughts':
					   startVideo('cutscenethree');		

					case 'closure':
					   startVideo('cutscenefive');				   
